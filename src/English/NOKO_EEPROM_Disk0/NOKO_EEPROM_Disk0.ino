/*
 * NOKO Settings EEPROM and Disk0 V1.0 26.01.2016 - Nikolai Radke - English
 * 
...
void setup() 
{
  ...
  if (parse && config) {
    ...
    Serial.print("Could not read the time, time=\"");
    Serial.print(__TIME__);
    Serial.print("\",Date=\"");
  ...
  EEPROM.write(27,1);
  EEPROM.write(28,0);
  Serial.println("Presets have been written to EEPROM.");
  
  // Write AT24C32
  Serial.println("Writing AT24C32:");
  Serial.println("Personalize NOKO...");
  ...
  #ifdef def_stories
    Serial.println("Length od Stories...");
