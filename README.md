...
### Prerequisites
NOKO needs Arduino IDE 1.6.6 - [1.6.9](https://www.arduino.cc/en/Main/Software) with AVR Boards Core 1.6.9. Copy the folder `NOKO/src/[language]/NOKO/` into your sketch folder. At this moment, *NOKO.ino* won't compile. The sketch size is too large. See [how to compile](https://github.com/NikolaiRadke/NOKO/tree/master/howto_compile) to solve this issue. If you are using AVR Boards Core 1.6.10 or higher, you need to install [Optiboot](https://github.com/Optiboot/optiboot) onto your Nano.  
