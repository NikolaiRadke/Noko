...
<table border="0">
  <tr>
    ...
    <td>
    NOKO is a multifunctional monster with an ATmega328 on an <b>Arduino Nano</b> microcontroller, display, clock, radio, mp3 player,           four buttons as user interface, battery, voice set and  tons of gimmicks, packed in a cuddly monster suit - sturdy,
