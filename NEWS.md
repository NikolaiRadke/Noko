...
## 2017
* **07.06.2017** - New IDE 1.8.3 tested. AVR Core 1.6.19 increases the sketch size by about 760 Bytes. IDE 1.8.3 with AVR Core 1.6.18 takes 17 Bytes more. NOKO stays with AVR Core 1.6.18.  
...
* **02.05.2017** - **Release V1.0-010517 - Buggy removed 29.05.2017**  
